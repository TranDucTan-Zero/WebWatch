  ...
  <body>
    <main>
        ...
        <div class="menu">
          ...
          <div class="container-info">
            ...
            <div class="Box-Square">
              <div class="content">
                  <h1>Tập đoàn NVTM</h1>
                  <p><b id="highlight-words">Quản lý:</b> Trần Đức Tân</p>
                  <p><b id="highlight-words">Chi nhánh:</b> Hỏi con My</p>
                  <p><b id="highlight-words">Liên hệ:</b> 0999999</p>
              </div>   
     ...
     <div class="Box-Square">
      <div class="content">
          <h1>Tập đoàn NVTM</h1>
          <p><b id="highlight-words">Quản lý:</b> Võ Thiện Nhân</p>
           <p><b id="highlight-words">Chi nhánh:</b> Hà Nội</p>
           <p><b id="highlight-words">Liên hệ:</b> 0888888</p>
      </div>   
          <div class="contact-icon">
              <!-- Icon social Network -->
              <a href="#!"><i class="fa-brands fa-facebook"></i></a>
   ...
   <div class="Box-Square">
      <div class="content">
      <h1>Tập đoàn NVTM</h1>
          <p><b id="highlight-words">Quản lý:</b> Châu Thị Diễm My</p>
           <p><b id="highlight-words">Chi nhánh:</b> Hồ Chi Minh</p>
           <p><b id="highlight-words">Liên hệ:</b> 07777777</p>
      </div>   
          <div class="contact-icon">
              <!-- Icon social Network -->
              <a href="#!"><i class="fa-brands fa-facebook"></i></a>
   ...
   <div class="Box-Square">
      <div class="content">
      <h1>Tập đoàn NVTM</h1>
          <p><b id="highlight-words">Quản lý:</b> Trần khách Vân</p>
           <p><b id="highlight-words">Chi nhánh:</b> Cần Thơ</p>
           <p><b id="highlight-words">Liên hệ:</b> 0666666</p>
      </div>   
          <div class="contact-icon">
              <!-- Icon social Network -->
              <a href="#!"><i class="fa-brands fa-facebook"></i></a>
